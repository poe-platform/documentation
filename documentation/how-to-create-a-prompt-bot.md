...
Describe what your bot should do or how it should behave. You can also use the "Prompt visible from bot profile" option to decide whether your prompt should be visible to the public.
