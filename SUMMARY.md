...
* [Welcome to Poe for Creators](README.md)
...
* [Sending files with your response](server-bots/sending-files-with-your-response.md)
...
* [Accessing HTTP request information](server-bots/accessing-http-request-information.md)
...
* [Poe Protocol Specification](server-bots/poe-protocol-specification/README.md)
  ...
  * [Requests](server-bots/poe-protocol-specification/requests/README.md)
    * [query](server-bots/poe-protocol-specification/requests/query.md)
    * [settings](server-bots/poe-protocol-specification/requests/settings.md)
