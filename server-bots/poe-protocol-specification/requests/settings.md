...
* `introduction_message` (string): Set a message that the bot will use to introduce itself to users at the start of a chat. This message supports markdown rendering; by default, bots will have no introduction.
